class Play extends Phaser.Scene {
    ...
    create(){
    	...
    	this.layers.push(new Layer(this, 1, this.layers, Phaser.Display.Color.GetColor(120,42,42), 0, [
    		...
    		{button: this.add.text(450, 150, 'Precipitate', { fill: '#fff' }), effect: ()=>{this.layers[2].quantity += 1}, requirement: 371}], 0))
    	this.layers.push(new Layer(this, 0, this.layers, Phaser.Display.Color.GetColor(0,0,200), 0, 
    		[{button: this.add.text(350, 100, 'Cycle water', { fill: '#fff' }), effect: ()=>{this.layers[2].passiveGrowth += 0.025}, requirement: 87}], 0))
